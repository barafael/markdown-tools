use crate::aggregator::{Aggregation, Aggregator};
use crate::link::Link;

use pulldown_cmark::{Event, Tag};

#[derive(Debug, Default)]
pub struct LinkIterator<'a, I> {
    state: Aggregator<'a>,
    iter: I,
}

impl<'a, I> LinkIterator<'a, I> {
...
impl<'a, I> Iterator for LinkIterator<'a, I>
where
...
mod test {
    ...
    fn aggregates_md() {
        ...
        let linkify = LinkIterator::new(parser);
        linkify.for_each(|e| {
            dbg!(e);
        });
    }
